...
void allMassPoints_fit() {
  ...
  const int nBins = 14;
  Double_t mass_xsec[nBins] = {1.2, 1.3, 1.4, 1.5, 1.8, 2.0, 2.2, 2.5, 2.8, 4., 5., 6., 7., 8.};
  Double_t xsec_higlu[nBins] = {
				//77910740,
				2631990, 1372070, 881140, 642097, 365239, 283080, 237671, 199051, 195270, 101029, 66799, 49249,  39060, 32812};
